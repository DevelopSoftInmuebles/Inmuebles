...
use Acme\DemoBundle\Entity\Ciudad;
use Acme\DemoBundle\Form\CiudadType;
...
class CiudadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeDemoBundle:Ciudad')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeDemoBundle:Ciudad:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeDemoBundle:Ciudad')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeDemoBundle:Ciudad:edit.html.twig")
     */
